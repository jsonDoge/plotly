  ...
  return (
    <div>
      ...
      <div className="space-x-2">
        ...
        <button type="button" className="btn btn-xs lg:btn-md btn-outline" onClick={() => setShowReceiveModal(true)}>
          Receive
        </button>
      </div>
    </div>
                ...
                {(query.data?.length ?? 0) > 5 && (
                  <tr>
                    <td colSpan={4} className="text-center">
                      <button type="button" className="btn btn-xs btn-outline" onClick={() => setShowAll(!showAll)}>
